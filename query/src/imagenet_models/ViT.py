...
df_validation.to_csv("./csv/imagenet/ViT_df_validation.csv", index=False)

df1k.to_csv("./csv/imagenet/ViT_df1k.csv", index=False)
df1k_pred.to_csv("./csv/imagenet/ViT_df1k_pred.csv", index=False)
