...
df_validation.to_csv("./synced_data/csv/imagenet/mit_df_validation.csv", index=False)

df1k.to_csv("./synced_data/csv/imagenet/mit_df1k.csv", index=False)
df1k_pred.to_csv("./synced_data/csv/imagenet/mit_df1k_pred.csv", index=False)
