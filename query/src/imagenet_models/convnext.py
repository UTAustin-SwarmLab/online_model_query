...
df_validation.to_csv("./csv/imagenet/convnext_df_validation.csv", index=False)

df1k.to_csv("./csv/imagenet/convnext_df1k.csv", index=False)
df1k_pred.to_csv("./csv/imagenet/convnext_df1k_pred.csv", index=False)
